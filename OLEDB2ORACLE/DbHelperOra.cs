...
namespace Maticsoft.DBUtility
{
    ...
    public abstract class DbHelperOra
    {
        ...
        /// <param name="ParamNames">在SQL语句中的参数名称列表(数组)</param>
        /// <param name="ParamValues">参数对应的值列表</param>
        public static void MyExecuteNonQueryClob(string sql, ArrayList ParamNames, ArrayList ParamValues)
        {
            ...
            using (OracleConnection connection = new OracleConnection(connectionString))
            {
                using (OracleCommand cmd = new OracleCommand(sql, connection))
                {
                    try
                    {
                        ...
                        {
                            OracleParameter op = new OracleParameter((string)ParamNames[i], OracleType.Clob);
                            op.Value = ParamValues[i];
